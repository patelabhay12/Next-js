...
const Hoodies = () => {
  return (
    <>
      <section className="text-gray-600 body-font lg:ml-24 md:ml-24 ">
            ...
            <div className="lg:w-1/5 md:w-1/3 p-4 w-full cursor-pointer shadow-lg m-2 grid justify-center ">
              <Link href={'/product/wear-the-code'} >
                <div className="block relative rounded overflow-hidden">
                  <img alt="ecommerce" className="m-auto md:mx-0 h-[30vh] md:h-[36vh] block" src="https://codeswear.nyc3.cdn.digitaloceanspaces.com/hoodies/your-design-here-hoodie-black/0.webp" />
                </div>
